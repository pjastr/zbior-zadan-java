...
15. Napisz statyczną metodę `reverseArray`, która przyjmuje tablicę liczb całkowitych jako argument i zwraca nową tablicę, ale z odwróconym porządkiem elementów. Na przykład, dla tablicy [1, 2, 3, 4, 5], funkcja powinna zwrócić [5, 4, 3, 2, 1]. Stwórz przypadek testowy. [^1]

[^1]: Zadanie zostało nieco poprawione. Stara wersja polecenia: Napisz statyczną metodę `reverseArray`, która przyjmuje tablicę liczb całkowitych jako argument i zwraca tę samą tablicę, ale z odwróconym porządkiem elementów. Na przykład, dla tablicy [1, 2, 3, 4, 5], funkcja powinna zwrócić [5, 4, 3, 2, 1]. Stwórz przypadek testowy.
