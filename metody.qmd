...
1. Napisz statyczną metodę, której jest dodatnia liczba całkowita $n$. Metoda ma zwrócić jako liczbę całkowitą sumę szeregu
...
5. Napisz statyczną metodę, której argumentem jest dodatnia liczba całkowita $n$. Metoda zwraca `true` jeśli zadana liczba $n$ jest nieparzysta, ujemna, (poza minusem) składa się z 4 cyfr i podzielna przez 5, oraz zwraca `false` w pozostałych przypadkach. Stwórz przypadek testowy dla metody. 
...
9. Napisz statyczną metodę, której argumentem jest dodatnia liczba całkowita $n$. Metoda zwraca wartość wyrażenia:
