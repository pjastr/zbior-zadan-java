...
$$v_0=1$$
$$v_{n} = \begin{cases} 
v_{n-1} + n, & \text{jeśli } n \text{ jest podzielne przez 4} \\
v_{n-1} \cdot 2, & \text{jeśli } n \text{ daje resztę 1 z dzielenia przez 4} \\
v_{n-1}^2 - 1, & \text{jeśli } n \text{ daje resztę 2 z dzielenia przez 4} \\
\lceil \frac{v_{n-1}}{3} \rceil, & \text{jeśli } n \text{ daje resztę 3 z dzielenia przez 4}
\end{cases}$$
